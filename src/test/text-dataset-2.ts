export const text_test_dataset_2 = [
  {
    id: 1,
    ...
    response:
      "The Eiffel Tower was completed in 1889. It was constructed from 1887 to 1889 as the centerpiece of the 1889 World's Fair in Paris.",
    expected: "",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    context:
      "Canberra is the capital city of Australia. Founded following the federation of the colonies of Australia as the seat of government for the new nation, it is Australia's largest inland city and the eighth-largest city overall. Unusual among Australian cities, it is an entirely planned city. The city is located at the northern end of the Australian Capital Territory; 280 km (170 mi) south-west of Sydney and 660 km (410 mi) north-east of Melbourne. As the seat of the government of Australia, Canberra is home to many important institutions of the federal government, national monuments and museums. This includes Parliament House, Government House, the High Court and numerous government departments and agencies. It is also the location of many social and cultural institutions of national significance such as the Australian War Memorial, the Australian National University, the Royal Australian Mint, the Australian Institute of Sport, the National Gallery, the National Museum and the National Library.",
    response:
      "The capital city of Australia is Canberra. It was founded as the seat of government for the new nation following the federation of the colonies of Australia.",
    expected: "",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    response:
      "World War II ended in 1945 after lasting for six years, from 1939 to 1945. It was the deadliest conflict in human history.",
    expected: "",
  },
];
